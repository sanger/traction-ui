...
<!-- 
   A standard form for importing multiple barcodes into traction.
...
const enablePrinting = computed(() =>
  ['SequencescapeTubes', 'SRJaguarKinnex'].includes(props.reception.value),
)
...
function resetLabwareData() {
  barcodes.value = ''
  Object.assign(labwareData, { foundBarcode: new Set(), attributes: [], inputBarcodes: [] })
}
