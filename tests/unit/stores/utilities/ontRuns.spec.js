...
describe('buildFormatedOntRun', () => {
    ...
    it('returns the formatted run object', () => {
      const result = buildFormatedOntRun(instruments, pools, fetchResponse.data, fetchResponse.included)
    ...
    it('handles missing instrument gracefully', () => {
      ...
      const result = buildFormatedOntRun(invalidInstruments, pools, fetchResponse.data, fetchResponse.included)
    ...
    it('handles missing pool gracefully', () => {
      const invalidPools = []
      const result = buildFormatedOntRun(instruments, invalidPools, fetchResponse.data, fetchResponse.included)
