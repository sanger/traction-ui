  ...
  describe('actions', () => {
    ...
    describe('fetchSmrtLinkVersions', () => {
      it('handles success', async () => {
        ...
        //Mock createObjectPopulatedBy
        const mockapi = vi.spyOn(jsonapi, 'createObjectPopulatedBy')
    ...
    describe('fetchRun', () => {
      it('handles success', async () => {
        ...
        //Mock getObjectPopulatedBy
        const mockApiPopulateBy = vi.spyOn(jsonapi, 'createObjectPopulatedBy')
        ...
        //Mock createObjectById
        const mockCreateObjectById = vi.spyOn(jsonapi, 'createObjectById')
        mockCreateObjectById.mockImplementation = vi.fn()
      ...
      it('handles failure', async () => {
        ...
        expect(mockCreateObjectById).not.toHaveBeenCalled()
        expect(success).toBeFalsy()
      })
    })
    ...
    describe('findPools', () => {
      it('returns the pool when given a valid tube barcode', async () => {
        ...
        // assert result
        expect(mockCreateObjectById).toBeCalledTimes(5) //pools,tubes,libraries, tags, requests

        //pools
        expect(mockCreateObjectById).toHaveBeenCalledWith({}, poolsArray, true)
        expect(store.pools).toEqual(
    ...
    describe('getOrCreateWell', () => {
      ...
      it('if it is an existing well', () => {
        ...
        const gottenWell = store.getOrCreateWell({ position: position, plateNumber })
