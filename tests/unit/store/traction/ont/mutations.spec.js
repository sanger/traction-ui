...
describe('selectPlate', () => {
  it('selects a plate by default', () => {
    ...
    // apply mutation
    mutations.selectPlate(state, { id: '1' })
  ...
  it('unselects plates', () => {
    ...
    // apply mutation
    mutations.selectPlate(state, { id: '2', selected: false })
    expect(state.selected.plates).toEqual({})
  })
})
...
describe('selectTube', () => {
  it('selects a tube by default', () => {
    ...
    // apply mutation
    mutations.selectTube(state, { id: '1' })
  ...
  it('unselects tubes', () => {
    ...
    // apply mutation
    mutations.selectTube(state, { id: '2', selected: false })
    expect(state.selected.tubes).toEqual({})
  })
})
...
describe('selectRequest', () => {
  ...
  it('unselects requests', () => {
    ...
    // apply mutation
    mutations.selectRequest(state, { id: '2', selected: false })
    expect(state.pooling.libraries).toEqual({})
  })
})
...
describe('selectTagSet', () => {
  it('updates the state', () => {
    ...
    // apply mutation
    mutations.selectTagSet(state, { id: '1' })
    // assert result
...
describe('updatePoolingLibrary', () => {
  it('updates a selected library', () => {
    ...
    // apply mutation
    mutations.updatePoolingLibrary(state, {
      ont_request_id: '2',
      tag_id: null,
      kit_barcode: null,
      volume: '30',
...
describe('populatePoolingLibraries', () => {
  it('populates the pooling libraries', () => {
    ...
    const state = defaultState()
    // apply mutation
    mutations.populatePoolingLibraries(state, Data.tractionOntLibraries.data.data)
...
describe('populatePoolAttributes', () => {
  it('sets the pool with the correct data', () => {
    const state = defaultState()
    // apply mutation
    mutations.populatePoolAttributes(state, Data.TractionOntPool.data.data)
...
describe('populatePoolingTube', () => {
  it('sets the tube with the correct data', () => {
    ...
    const state = defaultState()
    //apply mutation
    mutations.populatePoolingTube(state, tube)
...
describe('populatePools', () => {
  it('updates the state', () => {
    ...
    const state = defaultState()
    // apply mutation
    mutations.populatePools(state, pools)
    // assert result
...
describe('populateLibraries', () => {
  it('updates the state', () => {
    ...
    const state = defaultState()
    // apply mutation
    mutations.populateLibraries(state, libraries)
    // assert result
...
describe('populatePlates', () => {
  it('updates the state', () => {
    ...
    const state = defaultState()
    // apply mutation
    mutations.populatePlates(state, plates)
    // assert result
...
describe('populateTubes', () => {
  it('updates the state', () => {
    ...
    const state = defaultState()
    // apply mutation
    mutations.populateTubes(state, tubes)
    // assert result
...
describe('populateTagSets', () => {
  it('updates the state', () => {
    ...
    const state = defaultState()
    // apply mutation
    mutations.populateTagSets(state, tagSets)
    // assert result
...
describe('populateTags', () => {
  it('updates the state', () => {
    ...
    const state = defaultState()
    // apply mutation
    mutations.populateTags(state, tags)
    // assert result
...
describe('removeResource', () => {
  it('with a plate updates the state', () => {
    ...
    // apply mutation
    mutations.removeResource(state, { resource: 'plates', id: '1' })
    // assert result
  ...
  it('with a well updates the state', () => {
    ...
    // apply mutation
    mutations.removeResource(state, { resource: 'wells', id: '10' })
    // assert result
    expect(state.resources.wells).toEqual({
      11: { id: '11', type: 'wells', position: 'A2', requests: ['50'] },
    })
