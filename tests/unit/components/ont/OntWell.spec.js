...
describe('OntWell.vue', () => {
  ...
  beforeEach(() => {
    props = { 
      ...
      rx: "10.906492", 
      ry: "11.032985",
      well_info: { position: 'A1', materials: [{ name: 'SampleName' }] }
    }
  ...
  describe('#tooltip', () => {
    it('will display the materials sample name', () => {
      ...
      let expected = well.well_info.materials[0].name
      expect(title.text()).toEqual(expected)
    })

    it('will display the materials samples name', () => {
      props['well_info'] = { position: 'A1', materials: [{  name: 'SampleName1' }, { name: 'SampleName2' }] }
