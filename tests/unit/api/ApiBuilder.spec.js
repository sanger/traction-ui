...
//       expect(request1.baseURL).toEqual(process.env.VUE_APP_API1_BASE_URL)
//       expect(request1.apiNamespace).toEqual(config.api1.apiNamespace)
//       expect(request1.resource).toEqual(config.api1.resources.resource1.name)
//       expect(request1.headers).toBeDefined()
//       expect(request1.filter).toEqual(config.api1.resources.resource1.filter)
//       expect(request1.include).toEqual(config.api1.resources.resource1.include)

//       let request2 = api.api2.resource1
//       expect(request2.baseURL).toEqual(process.env.VUE_APP_API2_BASE_URL)
//       expect(request2.apiNamespace).toEqual(config.api2.apiNamespace)
//       expect(request2.resource).toEqual(config.api2.resources.resource1.name)
//       expect(request2.headers).toBeDefined()
//       expect(request2.filter).toEqual({})
//       expect(request2.include).toEqual('')
...
//       expect(request3.baseURL).toEqual(process.env.VUE_APP_API2_BASE_URL)
//       expect(request3.apiNamespace).toEqual(config.api2.apiNamespace)
//       expect(request3.resource).toEqual(config.api2.resources.resource2.name)
//       expect(request3.headers).toBeDefined()
//       expect(request3.filter).toEqual({})
//       expect(request3.include).toEqual('')
...
//       expect(request4.baseURL).toEqual(process.env.VUE_APP_API3_BASE_URL)
//       expect(request4.apiNamespace).toEqual(config.api3.apiNamespace)
//       expect(request4.resource).toEqual('samples')
//       expect(request4.headers).toBeDefined()
//       expect(request4.filter).toEqual({})
//       expect(request4.include).toEqual('')
...
//       expect(request5.apiNamespace).toEqual(config.api3.apiNamespace)
...
//       expect(request6.apiNamespace).toEqual(config.api3.apiNamespace)
...
//       expect(plates.apiNamespace).toEqual(config.api3.apiNamespace)
...
//       expect(wells.apiNamespace).toEqual(config.api3.apiNamespace)
