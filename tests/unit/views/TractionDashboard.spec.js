  ...
  describe('for pacbio', () => {
    ...
    describe('route buttons', () => {
      it('will have a plates button', () => {
        let platesButton = box.findAll('a').at(0)
